...
function App4() {
    ...
    return (
        ...
        <div className='hover:bg-gray-200 flex mt-[15px] ml-[15px] '>
                    <div className="group flex">
                        <img
                            ...
                            src="//theme.hstatic.net/200000420363/1001226108/14/hinhanhmenumenu14.png?v=30"
                            alt="logo"
                        />
        ...
        <div className=''>
        {Hovered && (
                <div className='w-[1108px] h-[800px] ml-[345px] shadow-gray-200 shadow-md rounded-r-[5px] mt-[-640px] bg-white '>

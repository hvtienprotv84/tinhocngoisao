        ...
        <div className='hover:bg-gray-200 mt-[15px] ml-[15px] hidden sm:inline-flex'>
                    <div className="group flex">
                        <img
                            ...
                            alt="logo"
                        />
                        <span className="ml-[5px] text-[14px] mt-[1px] w-[190px]">
                            PC Văn Phòng - Làm Việc
                        </span>
                    </div>
                    <FontAwesomeIcon className='mt-[10px] text-[8px] ml-[25px]' icon={faChevronRight} />
                </div>
                </div>   
        <div className=''>
        {Hovered && (
                <div className='w-[1108px] h-[800px] ml-[345px] shadow-gray-200 shadow-md rounded-r-[5px] mt-[-320px] bg-white '>

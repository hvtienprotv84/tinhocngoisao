...
function Menu_Mobile_OldAccessory() {
    ...
    return (
        ...
        <div className='flex flex-row items-center mt-[10px] mb-[10px] ml-[20px]'>
            ...
            <FontAwesomeIcon className='text-[16px] ml-[100px]' icon={showText ? faAngleDown : faAngleRight} onClick={toggleText}/>
        </div>
        ...
        {showText && ( // Conditionally render the text
                <div className='flex flex-col text-[14px] ml-[50px]'>
                    ...
                    <div className='pt-[10px]'>
                        ...
                        <FontAwesomeIcon className='text-[16px] ml-[100px]' icon={showText2 ? faAngleDown : faAngleRight} onClick={toggleText2}/>
                ...
                <div className='flex flex-col text-[14px]'>
                    ...
                    <div className='pt-[10px]'>
                        ...
                        <FontAwesomeIcon className='text-[16px] ml-[100px]' icon={showText3 ? faAngleDown : faAngleRight} onClick={toggleText3}/>
                        <hr className='bg-[#ccc] mt-[15px]'/>
                    </div>
                ...
                <div className='flex flex-col text-[14px]'>
                    ...
                    <div className='pt-[10px]'>
                        ...
                        <FontAwesomeIcon className='text-[16px] ml-[100px]' icon={showText4 ? faAngleDown : faAngleRight} onClick={toggleText4}/>
                        <hr className='bg-[#ccc] mt-[15px]'/>
                    </div>

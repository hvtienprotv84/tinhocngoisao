        ...
        <div className='hover:bg-gray-200 mt-[15px] ml-[15px] hidden sm:inline-flex'>
                    <div className="group flex">
                        <img
                            ...
                            src="//theme.hstatic.net/200000420363/1001226108/14/hinhanhmenumenu12.png?v=30"
                            alt="logo"
                        />
                        <span className="ml-[5px] text-[14px] mt-[1px] w-[180px]">
                            Phím, Chuột, Tai Nghe
                        </span>
                    </div>
                    <FontAwesomeIcon className='mt-[10px] text-[8px] ml-[35px]' icon={faChevronRight} />
                </div>
                </div>   
        <div className=''>
        {Hovered && (
                <div className='w-[1108px] h-[800px] ml-[345px] shadow-gray-200 shadow-md rounded-r-[5px] mt-[-545px] bg-white '>

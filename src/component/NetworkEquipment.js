...
function App4() {
    ...
    return (
        ...
        <div className='hover:bg-gray-200 mt-[15px] ml-[15px] hidden sm:inline-flex'>
                    <div className="group flex">
                        <img
                            ...
                            src="//theme.hstatic.net/200000420363/1001226108/14/hinhanhmenumenu13.png?v=30"
                            alt="logo"
                        />
        ...
        <div className=''>
        {Hovered && (
                <div className='w-[1108px] h-[800px] ml-[345px] shadow-gray-200 shadow-md rounded-r-[5px] mt-[-595px] bg-white '>

...
function SSD_HDD_USB() {
    ...
    return (
        ...
        >
        <div className='hover:bg-gray-200 mt-[17px] ml-[15px] hidden sm:inline-flex'>
        ...
        <div className=''>
        {Hovered && (
                <div className='w-[1108px] h-[800px] ml-[345px] shadow-gray-200 shadow-md rounded-r-[5px] mt-[-185px] bg-white '>
